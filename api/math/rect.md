...
The axis-aligned `Rect` type lives in the math headers (`math/Rect.h`) and is used throughout physics and rendering. See also [Vector2](/api/math/vector2) for overlap helpers.
