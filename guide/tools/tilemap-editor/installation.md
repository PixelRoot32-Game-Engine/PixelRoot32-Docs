...
The **PixelRoot32 Tilemap Editor** can be run from **pre-built** downloads (see [Releases](https://github.com/PixelRoot32-Game-Engine/PixelRoot32-Tool-Suite-Releases/releases) on the editor repository).
