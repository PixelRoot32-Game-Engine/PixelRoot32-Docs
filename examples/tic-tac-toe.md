...
Sample project: **[`examples/tic_tac_toe/`](https://github.com/PixelRoot32-Game-Engine/PixelRoot32-Game-Engine/tree/main/examples/tic_tac_toe)** — UI, GPIO vs touch input, minimax AI, vector-drawn board, and **`MusicPlayer`**.

Environments: `native`, `esp32dev`, `esp32cyd`.
