...
- Pipeline / layering: [Architecture — ESP32 rendering and tilemap caching](../../docs/architecture/architecture-index.md#esp32-rendering-pipeline-and-tilemap-caching)
- Static cache concept: [Architecture — Static tilemap layer cache](../../docs/architecture/architecture-index.md#static-tilemap-layer-cache-engine--scenes)
