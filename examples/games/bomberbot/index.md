...
![Bomberbot](screenshots/screenshot.png)
...
- [Grid cell occupancy pattern](https://github.com/PixelRoot32-Game-Engine/PixelRoot32-Game-Engine/blob/main/docs/patterns/grid-cell-occupancy.md) — the status-band-above-the-grid layout this example uses
- [`gameplay/GridSpace.h`](https://github.com/PixelRoot32-Game-Engine/PixelRoot32-Game-Engine/blob/main/include/gameplay/GridSpace.h) — the full grid conversion API

## Build

From **`games/bomberbot`**:
...
|-------|--------|---------|--------|
| All sprite art — player, enemies, bomb, explosion, tiles, power-ups | This repository | CC0 1.0 (public domain) | Original work, generated by [`tools/generate_cc0_assets.py`](tools/generate_cc0_assets.py); see [`src/assets/README.md`](src/assets/README.md) |
...
**Source code:** https://github.com/PixelRoot32-Game-Engine/PixelRoot32-Demo-Projects/tree/main/games/bomberbot
