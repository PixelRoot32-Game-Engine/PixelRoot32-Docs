...
-D PIXELROOT32_MAX_VELOCITY=300                  ; Max velocity (units/s, default)
...
- [API Reference](/api/) - Class documentation
- [Architecture](/architecture/overview) — System design
- [Migration guide v1.2.0](/guide/migrations/v1.2.0) — PhysicsActor flags packing changes
