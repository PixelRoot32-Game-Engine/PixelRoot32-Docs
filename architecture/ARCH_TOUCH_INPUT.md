...
For public API details (methods, parameters), see [Touch system API](/api/input/touch-system).
...
- [Touch system API](/api/input/touch-system)
- [Architecture overview](/architecture/overview) (layer diagram and subsystem context)
